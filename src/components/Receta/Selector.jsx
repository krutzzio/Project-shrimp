  ...
  return (
    <div className="w-fit text-xs text-red-500 font-semibold w-full">
      ...
      <div
        ...
        className={`bg-[#F2F2F2] w-full p-1 flex items-center justify-between rounded border ${!selected && "text-gray-700"
          }`}
      >
        {selected
          ? selected?.length > 25
      ...
      <ul
        className={`bg-[#F2F2F2] mt-2 overflow-y-auto ${open ? "max-h-60" : "max-h-0"
          } `}
      >
