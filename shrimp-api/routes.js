...
router.get('/restaurant', async (req, res) => await readItems(req, res, Usuario)); // Llegeix tots els restaurants
router.get('/restaurant/:id', async (req, res) => await readItem(req, res, Usuario)); // Llegeix un restaurant específic
router.put('/restaurant/:id', async (req, res) => await updateItem(req, res, Usuario)); // Actualitza un restaurant
router.delete('/restaurant/:id', async (req, res) => await deleteItem(req, res, Usuario)); // Elimina un restaurant
